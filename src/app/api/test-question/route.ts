...
export async function POST(request: NextRequest) {
  try {
    ...
    const testQuestion = await Question.create({
      ...
      order: 1,
      options: [
        { id: 'test1', type: 'mcq', content: 'let name: string = "John";', isCorrect: true },
        { id: 'test2', type: 'mcq', content: 'let name = string "John";', isCorrect: false }
      ],
      answer: { type: 'mcq', content: 'let name: string = "John";', optionId: 'test1' }
    });
