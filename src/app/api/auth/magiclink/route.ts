...
export async function POST(req: Request) {
  try {
    ...
    console.log('Magic Auth request for email:', email);
    ...
    if (existingUser) {
      console.log('User exists, sending magic auth code for login');
      ...
      console.log('User does not exist, sending magic auth code for registration');
