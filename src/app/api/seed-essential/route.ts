...
export async function POST() {
  try {
    ...
    const skillsData = [
      ...
      { name: 'Artificial Intelligence', description: 'Simulation of human intelligence' },
      { name: 'Blockchain', description: 'Distributed ledger technology' },
      { name: 'React Hooks', description: 'React state and lifecycle features' },
      { name: 'Redux', description: 'Predictable state container for JavaScript' }
    ];
    ...
    for (let i = 1; i <= 15; i++) {
      allLessons.push({
        ...
        contentArray: [`React Topic ${i}.1`, `React Topic ${i}.2`, `React Topic ${i}.3`],
        type: i % 2 === 0 ? 'Code' : 'Text',
    ...
    for (let i = 1; i <= 15; i++) {
      allLessons.push({
        ...
        contentArray: [`Node.js Topic ${i}.1`, `Node.js Topic ${i}.2`, `Node.js Topic ${i}.3`],
        type: i % 2 === 0 ? 'Code' : 'Text',
