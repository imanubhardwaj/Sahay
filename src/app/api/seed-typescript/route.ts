      ...
      if (lesson.order === 2) {
        ...
        questions.push(
          ...
          },
          {
            ...
            lessonId: lesson._id,
            moduleId: typescriptModule._id,
            questionText: `**Coding Challenge: TypeScript Interface**
...
Write your code in the editor below. The language is set to TypeScript.`,
        ...
        questions.push(
          ...
          },
          {
            ...
            lessonId: lesson._id,
            moduleId: typescriptModule._id,
            questionText: `**Coding Challenge: TypeScript Class**

Create a TypeScript class called 'Car' with the following requirements:
...
Write your code in the editor below. The language is set to TypeScript.`,
        ...
        questions.push(
          ...
          },
          {
            ...
            lessonId: lesson._id,
            moduleId: typescriptModule._id,
            questionText: `**Coding Challenge: Generic Interface**

Create a generic interface called 'Container<T>' with the following requirements:
- Property \`value\` of type T
- Method \`getValue()\` that returns T
...
Write your code in the editor below. The language is set to TypeScript.`,
        ...
        questions.push(
          ...
          },
          {
            ...
            lessonId: lesson._id,
            moduleId: typescriptModule._id,
            questionText: `**Coding Challenge: TypeScript Function with Array Methods**

Write a TypeScript function that takes an array of numbers and returns the sum of all even numbers.
