      ...
      if (lessonIndex === 0) {
        ...
        questions = [
          {
            ...
            explanation:
              "JavaScript is an interpreted language, meaning it's executed line by line at runtime.",
          },
          {
          ...
          },
          {
            ...
            explanation:
              "JavaScript engines (like V8, SpiderMonkey) execute JavaScript code in browsers.",
          },
          {
            ...
            explanation:
              "Inline JavaScript is written directly in HTML tag attributes like onclick.",
          },
          {
          ...
          },
          {
            ...
            explanation:
              "JavaScript uses // for single-line and /* */ for multi-line comments.",
          },
          {
            ...
            explanation:
              "The src attribute in <script> tag loads external JavaScript files.",
          },
          {
        ...
        questions = [
          ...
          },
          {
            ...
            explanation:
              "Symbol creates unique identifiers that cannot be duplicated.",
          },
          {
          ...
          },
          {
            ...
            explanation:
              "The + operator concatenates strings, so '5' + 3 becomes '53'.",
          },
          {
          ...
          },
          {
            ...
            explanation:
              "Number() returns NaN when it cannot convert the string to a number.",
          },
          {
        ...
        const questionTemplates = [
            ...
            options: [
              {
                id: "opt1",
                type: "mcq",
                content: "A fundamental concept from this lesson",
              },
              {
                id: "opt2",
                type: "mcq",
                content: "An advanced topic not covered yet",
              },
              {
                id: "opt3",
                type: "mcq",
                content: "A topic from a different lesson",
              },
            ],
            answer: {
              type: "mcq",
            ...
            options: [
              {
                id: "opt1",
                type: "mcq",
                content: "Understanding core JavaScript concepts",
              },
              {
                id: "opt2",
                type: "mcq",
          ...
          },
          {
            ...
            options: [
              {
                id: "opt1",
                type: "mcq",
                content: "Apply the concepts through coding exercises",
              },
              { id: "opt2", type: "mcq", content: "Skip to advanced topics" },
              {
                id: "opt3",
                type: "mcq",
                content: "Move to a different programming language",
              },
            ],
            answer: {
              type: "mcq",
            ...
            explanation:
              "Practice is essential to master the concepts covered in this lesson.",
          },
          {
            ...
            options: [
              {
                id: "opt1",
                type: "mcq",
                content: "It covers important JavaScript fundamentals",
              },
              {
                id: "opt2",
                type: "mcq",
                content: "It is optional for beginners",
              },
              {
                id: "opt3",
                type: "mcq",
                content: "It only applies to advanced developers",
              },
            ],
            answer: {
              type: "mcq",
          ...
          },
          {
            ...
            options: [
              {
                ...
                type: "mcq",
                content:
                  "Read the content, practice examples, and complete exercises",
              },
              {
                id: "opt2",
                type: "mcq",
                content: "Skip the examples and go straight to coding",
              },
              {
                id: "opt3",
                type: "mcq",
                content: "Only read the theory without practicing",
              },
            ],
            answer: {
              type: "mcq",
            ...
            explanation:
              "Active learning through reading, practicing, and completing exercises is the most effective approach.",
          },
          {
            ...
            options: [
              {
                id: "opt1",
                type: "mcq",
                content: "Complete the quiz and move to the next lesson",
              },
              {
                id: "opt2",
                type: "mcq",
                content: "Skip the quiz and jump ahead",
              },
              {
                id: "opt3",
                type: "mcq",
                content: "Review previous lessons only",
              },
            ],
            answer: {
              type: "mcq",
            ...
            explanation:
              "Completing the quiz helps reinforce your understanding before moving forward.",
          },
          {
            ...
            options: [
              {
                id: "opt1",
                type: "mcq",
                content: "Practical JavaScript skills",
              },
            ...
            explanation:
              "This lesson provides practical skills that you can apply in real JavaScript programming.",
          },
          {
            ...
            options: [
              {
                id: "opt1",
                type: "mcq",
                content: "Very important - it's part of the core curriculum",
              },
              { id: "opt2", type: "mcq", content: "Optional - can be skipped" },
              {
                id: "opt3",
                type: "mcq",
                content: "Only for advanced learners",
              },
            ],
            answer: {
              type: "mcq",
