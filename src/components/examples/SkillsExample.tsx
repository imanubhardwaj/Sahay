...
import { useSkills, useCreateSkill, useDeleteSkill } from "@/hooks";
              ...
              <div>
                ...
                {skill.parentSkillId && (
                  <p className="text-blue-600 text-xs">
                    Parent:{" "}
                    {skills.find((s) => s._id === skill.parentSkillId)?.name ||
                      "Unknown"}
                  </p>
                )}
              </div>
