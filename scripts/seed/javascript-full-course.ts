  ...
  const questionTemplates: Record<string, QuestionData[]> = {
    Variables: [
      ...
      },
      {
        ...
        answer: {
          type: "mcq",
          content: "Throws ReferenceError",
          optionId: "opt3",
        },
        explanation:
          "Accessing a let variable before declaration causes a ReferenceError due to temporal dead zone.",
      },
      {
        questionText:
        ...
        explanation:
          "Variable names must start with a letter, underscore, or dollar sign, and can contain letters, digits, underscores, and dollar signs.",
      },
      {
        ...
        options: [
          {
            id: "opt1",
            type: "mcq",
            content: "let is block-scoped, const is function-scoped",
          },
          {
            id: "opt2",
            type: "mcq",
            content: "const cannot be reassigned, let can be reassigned",
          },
        ...
        explanation:
          "The main difference is that const variables cannot be reassigned after declaration.",
      },
      {
        ...
        options: [
          {
            id: "opt1",
            type: "mcq",
            content: "Moving variables to the top of their scope",
          },
      ...
      {
        questionText:
          "What is the value of a variable that is declared but not initialized?",
        options: [
      ...
      {
        questionText:
          "Can you redeclare a variable with let in the same scope?",
        options: [
          ...
          { id: "opt3", type: "mcq", content: "Only in strict mode" },
          {
            id: "opt4",
            type: "mcq",
            content: "Only if it was previously declared with var",
          },
        ],
        answer: {
          type: "mcq",
          content: "No, it will cause an error",
          optionId: "opt2",
        },
        explanation:
      ...
      },
      {
        ...
        options: [
          {
            ...
            type: "mcq",
            content:
              "A period before a variable is declared where it cannot be accessed",
          },
        ...
        explanation:
          "The temporal dead zone is the period between entering scope and the declaration where the variable cannot be accessed.",
      },
      {
        questionText:
          "Which keyword creates a constant that cannot be reassigned?",
        options: [
      ...
      {
        questionText:
          "What happens when you declare a const object and try to modify its properties?",
        options: [
        ...
        answer: {
          type: "mcq",
          content: "Properties can be modified",
          optionId: "opt2",
        },
        explanation:
    ...
    Functions: [
        ...
        options: [
          {
            id: "opt1",
            type: "mcq",
            content: "A function assigned to a variable",
          },
          {
            id: "opt2",
            type: "mcq",
            content: "A function defined with the function keyword",
          },
        ...
        options: [
          {
            id: "opt1",
            type: "mcq",
            content: "Function declarations are hoisted, expressions are not",
          },
          {
            id: "opt2",
            type: "mcq",
            content: "Function expressions are hoisted, declarations are not",
          },
          { id: "opt3", type: "mcq", content: "There is no difference" },
          {
            id: "opt4",
            type: "mcq",
            content: "Function declarations cannot have parameters",
          },
        ],
        answer: {
          type: "mcq",
      ...
      },
      {
        ...
        options: [
          {
            id: "opt1",
            type: "mcq",
            content: "A function with arrow syntax =>",
          },
          { id: "opt2", type: "mcq", content: "A function declaration" },
          { id: "opt3", type: "mcq", content: "A type of loop" },
          { id: "opt4", type: "mcq", content: "A method" },
        ...
        explanation:
          "Arrow functions use the => syntax and have lexical this binding.",
      },
      {
        questionText:
        ...
        options: [
          {
            id: "opt1",
            type: "mcq",
            content: "Arrow functions have their own this context",
          },
          {
            id: "opt2",
            type: "mcq",
            content: "Arrow functions inherit this from the enclosing scope",
          },
          { id: "opt3", type: "mcq", content: "There is no difference" },
          {
            id: "opt4",
            type: "mcq",
            content: "Arrow functions cannot have parameters",
          },
        ],
        answer: {
          type: "mcq",
      ...
      },
      {
        ...
        options: [
          ...
          },
          {
            id: "opt2",
            type: "mcq",
            content: "A function that returns a function",
          },
          { id: "opt3", type: "mcq", content: "An arrow function" },
      ...
      },
      {
        ...
        options: [
          ...
          },
          {
            id: "opt2",
            type: "mcq",
            content: "A function with many parameters",
          },
          { id: "opt3", type: "mcq", content: "An arrow function" },
          { id: "opt4", type: "mcq", content: "A function declaration" },
        ],
      ...
      },
      {
        ...
        answer: {
          type: "mcq",
          content: "A function that has access to variables in its outer scope",
          optionId: "opt1",
        },
        explanation:
      ...
      },
      {
        ...
        options: [
          {
            ...
            type: "mcq",
            content:
              "Parameters are the values passed, arguments are the variables",
          },
          {
            id: "opt2",
            type: "mcq",
            content:
              "Arguments are the values passed, parameters are the variables",
          },
          { id: "opt3", type: "mcq", content: "There is no difference" },
          {
            id: "opt4",
            type: "mcq",
            content: "Parameters are only in arrow functions",
          },
        ],
        answer: {
          type: "mcq",
        ...
        explanation:
          "Parameters are the variables in the function definition, arguments are the values passed when calling the function.",
      },
      {
        ...
        options: [
          {
            id: "opt1",
            type: "mcq",
            content: "A parameter with a default value",
          },
          { id: "opt2", type: "mcq", content: "A required parameter" },
          {
            id: "opt3",
            type: "mcq",
            content: "A parameter that cannot be changed",
          },
        ...
        options: [
          {
            ...
            type: "mcq",
            content:
              "...args - allows a function to accept an indefinite number of arguments",
          },
    ...
    Variables: [
      {
        ...
        description:
          "Declare three variables: name (string), age (number), and isStudent (boolean). Assign appropriate values to each.",
        difficulty: "easy",
        category: "Variables",
        starterCode: {
        ...
        testCases: [
          {
            input: "none",
            expectedOutput: '{"name":"John","age":25,"is_student":true}',
            isHidden: false,
          },
        ],
        hints: [
          "Use let or const for variable declaration",
          "Assign string values with quotes",
      ...
      },
      {
        ...
        description:
          "Create a variable count initialized to 0, then increment it by 5, then multiply by 2. Return the final value.",
        difficulty: "easy",
        category: "Variables",
        starterCode: {
        ...
        testCases: [{ input: "none", expectedOutput: "10", isHidden: false }],
        hints: [
          "Start with count = 0",
          "Increment by 5: count = count + 5",
          "Multiply by 2: count = count * 2",
        ],
      },
    ],
    Functions: [
...
async function seedJavaScriptFullCourse() {
  try {
    ...
    await CodingProblem.deleteMany({
      category: {
        $in: ["Variables", "Functions", "Arrays", "Objects", "DOM", "Events"],
      },
    });
    ...
    for (const level of ["Beginner", "Intermediate", "Advanced"]) {
      ...
      const moduleName =
        level === "Beginner" ? "JavaScript Beginner" : `JavaScript ${level}`;

      // Calculate total duration (aim for 15-20 hours total, distribute across levels)
      const hoursPerLevel =
        level === "Beginner" ? 8 : level === "Intermediate" ? 6 : 6;
